...
trait RelationShip
{
    ...
    protected function isRelationAttr(string $attr)
    {
        ...
        if ((method_exists($this, $relation) && !method_exists('iboxs\Model', $relation)) || isset(static::$macro[static::class][$relation])) {
            return $relation;
        }
